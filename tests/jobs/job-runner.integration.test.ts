      ...
      async () => {
        return {
          ...
          result: buildJobResult(
            ...
            new Date(),
            new Date(),
            { attempted: 10, succeeded: 10, skipped: 0, failed: 0, retryableFailures: 0 },
            null,
            null,
          ),
        } as JobOutcome;
      ...
      async () => {
        ...
        return {
          ...
          result: buildJobResult(
            ...
            new Date(),
            new Date(),
            { attempted: 5, succeeded: 5, skipped: 0, failed: 0, retryableFailures: 0 },
            null,
            null,
          ),
        } as JobOutcome;
      ...
      async () => {
        return {
          ...
          result: buildJobResult(
            ...
            new Date(),
            new Date(),
            { attempted: 1, succeeded: 1, skipped: 0, failed: 0, retryableFailures: 0 },
            null,
            null,
          ),
        } as JobOutcome;
